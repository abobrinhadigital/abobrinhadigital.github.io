...
<div style="text-align: center; margin-bottom: 50px; margin-top: 20px;">
  <img src="assets/images/abobrinha-digital-new-small.png" alt="Logo Abobrinha Digital" style="width: 120px; height: 120px; border-radius: 50%; border: 2px solid #333; box-shadow: 0 4px 8px rgba(0,0,0,0.3); margin-bottom: 25px;">
